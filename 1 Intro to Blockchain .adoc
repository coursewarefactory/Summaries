...
=== What are the draw backs of byzantine general probelem?
==== Oral message is not sufficient to trasnmit message
...
The internet and web were created as open platforms that any user, developer, organization could access equally. Among other things, this allowed independent developers to build products that quickly gained widespread adoption. Google started in a Menlo Park garage and Facebook started in a Harvard dorm room. They competed on a level playing field because they were built on decentralized networks governed by open protocols

=== What were the innovations of bitcoin?
==== It is a store of value for people
==== It is a new way to develop open network
